...
Lobby lobby1 = new Lobby(1L, "Lobby 1", new Timestamp(System.currentTimeMillis()), "lobby", 2, 4);
Lobby lobby2 = new Lobby(2L, "Lobby 2", new Timestamp(System.currentTimeMillis()), "lobby", 1, 2);
Lobby lobby3 = new Lobby(3L, "Lobby 3", new Timestamp(System.currentTimeMillis()), "lobby", 3, 3);
